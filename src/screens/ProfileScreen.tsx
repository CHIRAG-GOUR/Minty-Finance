...
export const ProfileScreen: React.FC = () => {
  ...
  const handleReset = () => {
    Alert.alert(
      ...
      'Are you sure you want to reset your virtual portfolio, wallet, and achievements back to initial starting state?',
      [
        { text: 'Cancel', style: 'cancel' },
        { text: 'Reset All', style: 'destructive', onPress: resetSimulationData },
      ]
    );
  };
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>
          Financial track record, leaderboards & parent trust guide
        </Text>
      </View>
      ...
      <View style={styles.tabNavRow}>
        {[
          ...
          { id: 'trust', label: 'Parent Safety', icon: 'shield' },
      ...
      >
        ...
        {activeSubTab === 'profile' && (
          <>
            ...
            {/* Danger / Reset Zone */}
            <View style={[styles.sectionCard, { borderColor: THEME.colors.coralSurface }]}>
              <Text style={[styles.cardTitle, { color: THEME.colors.coral }]}>
                Simulation Sandbox Controls
              </Text>
              <Text style={styles.resetDesc}>
                Resetting will restore your virtual balance to ₹10,000 and clear all simulated holdings and transaction logs.
              </Text>
              <PrimaryButton
                title="Reset Simulation Sandbox"
                iconName="refresh"
                variant="danger"
                onPress={handleReset}
                size="md"
            ...
            <View style={styles.leaderboardBanner}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.bannerSub}>
                  Rankings are based on educational XP, completed challenges, and smart portfolio diversification.
                </Text>
              </View>
            </View>
        ...
        {activeSubTab === 'trust' && (
          <View style={styles.trustContainer}>
            ...
            <View style={styles.trustPointCard}>
              <View style={styles.trustIconCircle}>
                <Icon name="check" size={18} color={THEME.colors.obsidian} />
              </View>
              <View style={styles.trustPointText}>
                <Text style={styles.pointTitle}>100% Virtual Currency Only</Text>
                <Text style={styles.pointBody}>
                  There are no bank connections, no real debit/credit cards, and no payment gateways. Every rupee shown is purely fictional simulation balance.
                </Text>
              </View>
            </View>
            ...
            <View style={styles.trustPointCard}>
              ...
              <View style={styles.trustPointText}>
                <Text style={styles.pointTitle}>Responsible Habits Over Speculation</Text>
                <Text style={styles.pointBody}>
                  The app penalizes reckless concentration and rewards the 50/30/20 budgeting rule, emergency safety nets, and diversified compound growth.
                </Text>
              </View>
            </View>
            ...
            <View style={styles.trustPointCard}>
              ...
              <View style={styles.trustPointText}>
                <Text style={styles.pointTitle}>Zero Real-Money Risk</Text>
                <Text style={styles.pointBody}>
                  Teenagers can make investment mistakes, analyze downside volatility, and learn from experience in a completely secure virtual sandbox.
                </Text>
              </View>
            </View>
          </View>
