      ...
      <View style={styles.header}>
        <View style={styles.headerTextCol}>
          ...
          <Text style={styles.subtitle} numberOfLines={2}>
            Live valuation · Positions & transaction ledger
          </Text>
        </View>
            ...
            {portfolioAnalytics.enrichedStocks.length === 0 ? (
              <View style={styles.emptyCard}>
                ...
                <Text style={styles.emptySub}>
                  Explore listed Indian equities on the Markets tab to place your first order.
                </Text>
              </View>
            ) : (
          ...
          <View style={styles.section}>
            {transactions.length === 0 ? (
              <View style={styles.emptyCard}>
                ...
                <Text style={styles.emptySub}>
                  Every order and its statutory charges are recorded here.
                </Text>
              </View>
            ) : (
              transactions.map((tx) => (
          ...
          <View style={styles.section}>
            <View style={styles.labCard}>
              ...
              <View style={{ marginTop: 14 }}>
                <PrimaryButton
                  title="Run Projection & Claim +25 XP"
                  iconName="award"
