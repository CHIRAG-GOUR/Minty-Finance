      ...
      >
        ...
        <View style={styles.incomeCard}>
          <View style={styles.incomeHeader}>
            <View style={styles.incomeLeft}>
              ...
              <View>
                <Text style={styles.incomeLabel}>Virtual Monthly Income</Text>
                {editingIncome ? (
        ...
        <View style={styles.summaryCard}>
          <View style={styles.summaryTop}>
            <View>
              <Text style={styles.savingsLabel}>Simulated Savings Rate</Text>
        ...
        <View style={styles.mintiTipsCard}>
          ...
          {savingsRatePercent < 20 ? (
            <Text style={styles.mintiTipBody}>
              You are currently saving {savingsRatePercent}%, which is below the 20% golden rule. Consider shifting ₹500 from entertainment to your virtual index fund to accelerate your compound growth.
            </Text>
          ) : (
            <Text style={styles.mintiTipBody}>
